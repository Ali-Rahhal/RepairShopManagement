...
namespace RepairShop.Migrations
{
    ...
    [Migration("20260628165153_AddedReceptionNoteAndReceptionNoteItemTables")]
    partial class AddedReceptionNoteAndReceptionNoteItemTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RepairShop.Models.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RepairShop.Models.DefectiveUnit", b =>
                {
                    ...
                    b.Property<bool>("InvoiceByBachir")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("RepairShop.Models.DefectiveUnitNote", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RepairShop.Models.PartStockHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("TransactionBodyId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TransactionBodyId");

                    b.HasIndex("UserId");

                    b.ToTable("PartStockHistory");
                });

            modelBuilder.Entity("RepairShop.Models.PreventiveMaintenanceRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RepairShop.Models.Client", b =>
                {
                    b.HasOne("RepairShop.Models.Client", "ParentClient")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("RepairShop.Models.PartStockHistory", b =>
                {
                    ...
                    b.HasOne("RepairShop.Models.TransactionBody", "TransactionBody")
                        .WithMany()
                        .HasForeignKey("TransactionBodyId");
            ...
            modelBuilder.Entity("RepairShop.Models.PreventiveMaintenanceRecord", b =>
                {
                    b.HasOne("RepairShop.Models.Client", "Client")
                        .WithMany("PreventiveMaintenanceRecords")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RepairShop.Models.Client", b =>
                {
                    ...
                    b.Navigation("PreventiveMaintenanceRecords");
