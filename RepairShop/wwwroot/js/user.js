...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "columns": [//defining the columns of the datatable and mapping them to the properties of the user model.
            { data: 'userName', "width": "25%" },//dont forget the names should match the property names.
            { data: 'role', "width": "25%" },
            {
                data: 'id',
                "render": function (data) {//this is to render the edit and delete buttons in the last column.
                    return `<div class="w-75 btn-group" role="group">
                    <a href="/Admin/Users/Edit?id=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i> Edit</a>
                    <!--onclick is for initiating Delete function and passing the url with id-->
                    <a onClick=Delete('/Admin/Users/Index?handler=Delete&id=${data}') class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i> Delete</a>
